...
def createEvent(manualReset: bool = False, initialState: bool = False) -> int:
    ...
    """
def createSemaphore(initialCount: typing.SupportsInt | typing.SupportsIndex = 0, maximumCount: typing.SupportsInt | typing.SupportsIndex = 2147483647) -> int:
    """
    ...
    """
def createSignalObject(handle: typing.SupportsInt | typing.SupportsIndex, manualReset: bool = False, initialState: bool = False) -> None:
    """
    ...
    """
def destroyEvent(handle: typing.SupportsInt | typing.SupportsIndex) -> None:
    """
    Destroys an event.  Destruction wakes up any waiters.
    
    :param handle: event handle
    """
def destroySemaphore(handle: typing.SupportsInt | typing.SupportsIndex) -> None:
    """
    Destroys a semaphore.  Destruction wakes up any waiters.
    
    :param handle: semaphore handle
    """
def destroySignalObject(handle: typing.SupportsInt | typing.SupportsIndex) -> None:
    """
    Cleans up signaling for a handle.  Destruction wakes up any waiters.
    
    :param handle: handle
    """
def releaseSemaphore(handle: typing.SupportsInt | typing.SupportsIndex, releaseCount: typing.SupportsInt | typing.SupportsIndex = 1) -> tuple[bool, int]:
    """
    ...
    """
def resetEvent(handle: typing.SupportsInt | typing.SupportsIndex) -> None:
    """
    Sets an event to non-signaled state.
    
    :param handle: event handle
    """
def resetSignalObject(handle: typing.SupportsInt | typing.SupportsIndex) -> None:
    """
    Sets a handle to non-signaled state.
    
    :param handle: handle
    """
def setEvent(handle: typing.SupportsInt | typing.SupportsIndex) -> None:
    """
    Sets an event to signaled state.
    
    :param handle: event handle
    """
def setSignalObject(handle: typing.SupportsInt | typing.SupportsIndex) -> None:
    """
    ...
    """
@typing.overload
def waitForObject(handle: typing.SupportsInt | typing.SupportsIndex) -> bool:
    """
    ...
    """
@typing.overload
def waitForObject(handle: typing.SupportsInt | typing.SupportsIndex, timeout: typing.SupportsFloat | typing.SupportsIndex) -> tuple[bool, bool]:
    """
    ...
    """
@typing.overload
def waitForObjects(handles: list[typing.SupportsInt | typing.SupportsIndex]) -> list[int]:
    """
    ...
    """
@typing.overload
def waitForObjects(handles: list[typing.SupportsInt | typing.SupportsIndex], timeout: typing.SupportsFloat | typing.SupportsIndex) -> tuple[list[int], bool]:
    """
