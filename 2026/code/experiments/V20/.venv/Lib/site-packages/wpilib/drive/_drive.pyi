    ...
    * :meth:`curvatureDrive` is similar in concept to
    ...
    class WheelSpeeds:
        ...
        def right(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> None:
            ...
    @staticmethod
    def arcadeDriveIK(xSpeed: typing.SupportsFloat | typing.SupportsIndex, zRotation: typing.SupportsFloat | typing.SupportsIndex, squareInputs: bool = True) -> DifferentialDrive.WheelSpeeds:
        """
        ...
        """
    @staticmethod
    def curvatureDriveIK(xSpeed: typing.SupportsFloat | typing.SupportsIndex, zRotation: typing.SupportsFloat | typing.SupportsIndex, allowTurnInPlace: bool) -> DifferentialDrive.WheelSpeeds:
        """
        ...
        """
    @staticmethod
    def tankDriveIK(leftSpeed: typing.SupportsFloat | typing.SupportsIndex, rightSpeed: typing.SupportsFloat | typing.SupportsIndex, squareInputs: bool = True) -> DifferentialDrive.WheelSpeeds:
        """
    ...
    def __init__(self, leftMotor: wpilib.interfaces._interfaces.MotorController, rightMotor: wpilib.interfaces._interfaces.MotorController) -> None:
        ...
        """
    @typing.overload
    def __init__(self, leftMotor: collections.abc.Callable[[typing.SupportsFloat | typing.SupportsIndex], None], rightMotor: collections.abc.Callable[[typing.SupportsFloat | typing.SupportsIndex], None]) -> None:
        """
        Construct a DifferentialDrive.
        ...
        """
    def arcadeDrive(self, xSpeed: typing.SupportsFloat | typing.SupportsIndex, zRotation: typing.SupportsFloat | typing.SupportsIndex, squareInputs: bool = True) -> None:
        """
        ...
        :param squareInputs: If set, decreases the input sensitivity at low speeds.
        """
    def curvatureDrive(self, xSpeed: typing.SupportsFloat | typing.SupportsIndex, zRotation: typing.SupportsFloat | typing.SupportsIndex, allowTurnInPlace: bool) -> None:
        """
    ...
    def stopMotor(self) -> None:
        ...
    def tankDrive(self, leftSpeed: typing.SupportsFloat | typing.SupportsIndex, rightSpeed: typing.SupportsFloat | typing.SupportsIndex, squareInputs: bool = True) -> None:
        """
...
class MecanumDrive(RobotDriveBase, wpiutil._wpiutil.Sendable):
    ...
    class WheelSpeeds:
        ...
        def frontLeft(self) -> float:
            ...
            """
        @frontLeft.setter
        def frontLeft(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> None:
            ...
        @property
        def frontRight(self) -> float:
            ...
            """
        @frontRight.setter
        def frontRight(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> None:
            ...
        @property
        def rearLeft(self) -> float:
            ...
            """
        @rearLeft.setter
        def rearLeft(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> None:
            ...
        @property
        def rearRight(self) -> float:
            ...
            """
        @rearRight.setter
        def rearRight(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> None:
            ...
    @staticmethod
    def driveCartesianIK(xSpeed: typing.SupportsFloat | typing.SupportsIndex, ySpeed: typing.SupportsFloat | typing.SupportsIndex, zRotation: typing.SupportsFloat | typing.SupportsIndex, gyroAngle: wpimath.geometry._geometry.Rotation2d = ...) -> MecanumDrive.WheelSpeeds:
        """
    ...
    def __init__(self, frontLeftMotor: wpilib.interfaces._interfaces.MotorController, rearLeftMotor: wpilib.interfaces._interfaces.MotorController, frontRightMotor: wpilib.interfaces._interfaces.MotorController, rearRightMotor: wpilib.interfaces._interfaces.MotorController) -> None:
        ...
        """
    @typing.overload
    def __init__(self, frontLeftMotor: collections.abc.Callable[[typing.SupportsFloat | typing.SupportsIndex], None], rearLeftMotor: collections.abc.Callable[[typing.SupportsFloat | typing.SupportsIndex], None], frontRightMotor: collections.abc.Callable[[typing.SupportsFloat | typing.SupportsIndex], None], rearRightMotor: collections.abc.Callable[[typing.SupportsFloat | typing.SupportsIndex], None]) -> None:
        """
        Construct a MecanumDrive.
        ...
        """
    def driveCartesian(self, xSpeed: typing.SupportsFloat | typing.SupportsIndex, ySpeed: typing.SupportsFloat | typing.SupportsIndex, zRotation: typing.SupportsFloat | typing.SupportsIndex, gyroAngle: wpimath.geometry._geometry.Rotation2d = ...) -> None:
        """
        ...
        :param gyroAngle: The gyro heading around the Z axis. Use this to implement
                          field-oriented controls.
        """
    def drivePolar(self, magnitude: typing.SupportsFloat | typing.SupportsIndex, angle: wpimath.geometry._geometry.Rotation2d, zRotation: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
        Drive method for Mecanum platform.
...
class RobotDriveBase(wpilib._wpilib.MotorSafety):
    ...
    @staticmethod
    def _desaturate(wheelSpeeds: list[typing.SupportsFloat | typing.SupportsIndex]) -> None:
        """
    ...
    def getDescription(self) -> str:
        ...
    def setDeadband(self, deadband: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
        ...
        """
    def setMaxOutput(self, maxOutput: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
    ...
    def _m_deadband(self) -> float:
        ...
        """
    @_m_deadband.setter
    def _m_deadband(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
    @property
    def _m_maxOutput(self) -> float:
        ...
        """
    @_m_maxOutput.setter
    def _m_maxOutput(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
