...
struct bind_frc__SlewRateLimiter {
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_SlewRateLimiter.def("setLimit", static_cast<void (frc::SlewRateLimiter<Unit>::*)(Rate_t, Rate_t)>(&frc::SlewRateLimiter<Unit>::SetLimit)
      , py::arg("positiveRateLimit"), py::arg("negativeRateLimit")
      , release_gil()
      , py::doc(
    ...
    cls_SlewRateLimiter.def("setLimit", static_cast<void (frc::SlewRateLimiter<Unit>::*)(Rate_t)>(&frc::SlewRateLimiter<Unit>::SetLimit)
      , py::arg("rateLimit")
      , release_gil()
      , py::doc(
