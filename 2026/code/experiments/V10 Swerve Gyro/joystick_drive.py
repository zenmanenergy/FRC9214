...
class DriverJoystickConfig:
	...
	# Buttons
	FIELD_RELATIVE_BUTTON = 1  # A button
	SLOW_MODE_BUTTON = 2  # B button
	STOP_BUTTON = 4  # X button
	RESET_GYRO_BUTTON = 3  # Y button
...
class DriverJoystick:
	...
	def get_reset_gyro_button_pressed(self) -> bool:
		"""Check if reset gyro button was pressed."""
		return self.joystick.getRawButtonPressed(self.config.RESET_GYRO_BUTTON)
