...
class Tachometer(wpiutil._wpiutil.Sendable):
    ...
    def getStopped(self) -> bool:
        ...
        """
    def setEdgesPerRevolution(self, edges: typing.SupportsInt | typing.SupportsIndex) -> None:
        """
    ...
    def setMaxPeriod(self, maxPeriod: wpimath.units.seconds) -> None:
        ...
        """
    def setSamplesToAverage(self, samples: typing.SupportsInt | typing.SupportsIndex) -> None:
        """
